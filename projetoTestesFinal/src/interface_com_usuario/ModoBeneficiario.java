...
public class ModoBeneficiario {
        ...
        do{
            ...
            switch(opcao){
                ...
                case '1':
                    ...
                    rodarGerenciamentoCartao(TiposCartaoBeneficio.VALE_ALIMENTACAO);
                ...
                case '2':
                    ...
                    rodarGerenciamentoCartao(TiposCartaoBeneficio.VALE_REFEICAO);
                    Impressora.msgRedirecionamento("Voltando ao menu de escolha do cartão");
                    break;
                ...
                case '3':
                    ...
                    rodarGerenciamentoCartao(TiposCartaoBeneficio.VALE_COMBUSTIVEL);
                    Impressora.msgRedirecionamento("Voltando ao menu de escolha do cartão");
                    break;
            }
    ...
    private void rodarGerenciamentoCartao(TiposCartaoBeneficio tipoCartao){
    ...
    private void rodarPassarCartao(TiposCartaoBeneficio tipoCartao){
